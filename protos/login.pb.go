...
func (x *UserInfo) GetDevice() string {
	if x != nil {
		return x.Device
	}
	return ""
...
func (x *Success) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_login_proto_rawDesc = []byte{
	...
	0x5a, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x75,
	...
	,
...
var file_login_proto_goTypes = []interface{}{
	...
	(*Success)(nil),  // 1: protos.Success
	(*Result)(nil),   // 2: protos.Result
}
var file_login_proto_depIdxs = []int32{
	0, // 0: protos.UserSrv.Login:input_type -> protos.UserInfo
	2, // 1: protos.UserSrv.Login:output_type -> protos.Result
...
type UserSrvClient interface {
	Login(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *userSrvClient) Login(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/protos.UserSrv/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedUserSrvServer) Login(context.Context, *UserInfo) (*Result, error) {
...
func _UserSrv_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.UserSrv/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserSrvServer).Login(ctx, req.(*UserInfo))
	}
